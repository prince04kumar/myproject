  ...
  return (
    <div className='min-h-screen relative bg-black/90 text-white'>
        ...
        <div className='flex flex-col items-center justify-start w-full px-6 py-8 max-w-7xl mx-auto'>
            <h1 className='text-3xl md:text-4xl font-bold mb-2 font-playfair'>Projects Management</h1>
            <p className='text-blue-300 mb-6 text-center'>Add or manage your portfolio projects</p>
            ...
            {showForm && (
                <div className='bg-gray-900/70 backdrop-blur border border-gray-700 shadow-lg rounded-xl p-6 mb-10 w-full max-w-xl'>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className='mb-4'>
                            <label className='block mb-2 text-sm' htmlFor="Title">Project Title</label>
                            <input
                                type="text"
                                id="Title"
                        ...
                        <div className='mb-4'>
                            <label className='block mb-2 text-sm' htmlFor="Description">Project Description</label>
                            <textarea
                                id="Description"
                        ...
                        <div className='mb-6'>
                            <label className='block mb-2 text-sm' htmlFor="imagefile">Project Image</label>
            ...
            <div className='w-full'>
                <h2 className='text-xl font-semibold mb-4 text-blue-200'>Current Projects</h2>
                ...
                {loading && !showForm ? (
                            ...
                            <div key={project.id} className='bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl overflow-hidden shadow-lg transition-all hover:shadow-blue-900/20 hover:border-gray-700'>
                                <div className="flex flex-col md:flex-row">
                                    ...
                                    <div className="md:w-1/6 p-4 flex md:flex-col justify-end items-center gap-3 border-t md:border-l md:border-t-0 border-gray-800">
                                        ...
                                        <button
                                            className='flex items-center gap-2 px-3 py-2 bg-blue-900/20 hover:bg-blue-900/40 text-blue-300 rounded-lg transition-colors'
                                        >
                                            <Edit size={16} />
                                            <span>Edit</span>
                                        </button>
                    ...
                    <div className='text-center py-16 px-6 bg-gray-900/50 backdrop-blur border border-gray-800 rounded-xl'>
                        ...
                        <h3 className="text-xl font-medium text-gray-200 mb-2">No projects added yet</h3>
                        <p className='text-gray-400 mb-6'>Add your first project to display in your portfolio</p>
                        <button 
                            onClick={() => setShowForm(true)}
